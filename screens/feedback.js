  ...
  return (
    <View style={styles.container}>
      <Surface style={styles.surface} elevation={4}>
        ...
        {/* Question 1 */}
        <Text style={styles.question}>Question 1. How well did you sleep?</Text>
        ...
        {/* Question 2 */}
        <Text style={styles.question}>Question 2. Did you face any interruption in between the sleep session? Did you wake up in between?</Text>
        ...
        {/* Question 3 */}
        <Text style={styles.question}>Question 3. Did you consume caffeine prior to sleeping?</Text>
        ...
        {/* Question 4 */}
        <Text style={styles.question}>Question 4. Did you consume alcohol before sleeping?</Text>
